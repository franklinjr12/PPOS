...
int ppos_timer_start;
extern int ppos_task_id_counter;
extern int ppos_task_id_actual;
extern char *ppos_task_stack;
extern task_t ppos_task_controller;
extern task_t ppos_task_last;
int main(int argc, char *argv[]);
struct _ppos_scheduler
{
    int current;
    int user_tasks;
    task_t dispatcher;
...
extern struct _ppos_scheduler ppos_scheduler;
